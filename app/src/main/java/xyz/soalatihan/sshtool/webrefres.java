package xyz.soalatihan.sshtool;
...
public class webrefres extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void loadWebsite() {
        ...
        if (netInfo != null && netInfo.isConnectedOrConnecting()) {
            mWebView.loadUrl("https://paduanmembuat.blogspot.com/");
        } else {
